...
<body>
    ...
    (function(d, s, id) {
        ...
        js.id = id;
        js.src =
            'https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v3.0&appId=1773857816252117&autoLogAppEvents=1';
                ...
                <div class="medium-9 small-12 columns text-center text-medium-right">
                    ...
                    <div class="action-box">
                        <p><i class="fa fa-envelope-o" aria-hidden="true"></i> <a
                                href="mailto:<?php echo $res['site_email']; ?>"><?php echo $res['site_email']; ?></a>
                        </p>
                        <!-- icon box ends -->
        ...
        <div class="header-wrap">
            <div class="row">
                <div class="medium-4 small-12 columns logo">
                    <a href="./">
                        <img alt="" src="haryana_img/400dpiLogoCropped.jpg" width="500" height='1200' />
                    </a>
                </div><!-- logo ends -->
                <div class="medium-8 small-12 columns nav-wrap">
                    ...
                    <div class="top-bar">
                        ...
                        <nav id="responsive-menu">
                            <ul class="menu vertical medium-horizontal float-right"
                                data-responsive-menu="accordion medium-dropdown">
                                <li><a href="./">Home Page</a> </li>
                                <li><a href="about.php">Über Uns</a></li>
                                <li><a href="speisekarte.php">Spiesekarte</a></li>
