                ...
                <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" data-version="5.0.7">
                    <ul>	<!-- SLIDE  -->
                        <li data-index="rs-16" data-transition="zoomout" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off">
                            <!-- MAIN IMAGE -->
                            <img src="haryana_img/cover.jpg"  alt="First Slide"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" />
                            <!-- LAYERS -->
                            ...
                            <div class="tp-caption Newspaper-Title-Centered layer2 tp-resizeme rs-parallaxlevel-0" 
                                ...
                                data-splitin="none" 
                                data-splitout="none" 
                                data-responsive_offset="on">Frisch und Qüalität
                            </div>
                            ...
                            <div class="tp-caption Newspaper-Button layer4 rev-btn rs-parallaxlevel-0" 
                                ...
                                data-splitout="none" 
                                data-responsive_offset="on" 
                                data-responsive="off"><a href="about.php">Mehr erfahren</a> 
                            </div>
                        </li>
                        <!-- SLIDE  -->
                        <li data-index="rs-17" data-transition="fadetotopfadefrombottom" data-slotamount="default"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1500" data-rotate="0"  data-saveperformance="off">
                            <!-- MAIN IMAGE -->
                            <img src="haryana_img/cover_2.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            ...
                            <div class="tp-caption Newspaper-Title-Centered layer2 tp-resizeme rs-parallaxlevel-0" 
                                ...
                                data-splitin="none" 
                                data-splitout="none" 
                                data-responsive_offset="on">Wir sind immer für Sie. 
                            </div>
                            ...
                            <div class="tp-caption Newspaper-Button layer4 rev-btn rs-parallaxlevel-0" 
                                ...
                                data-splitout="none" 
                                data-responsive_offset="on" 
                                data-responsive="off"><a href="about.php">Jetz Sofort Bestellen</a> 
                            </div>
                        </li>
                        <!-- SLIDE  -->
                        <li data-index="rs-18" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"  data-saveperformance="off">
                            <!-- MAIN IMAGE -->
                            <img src="haryana_img/cover_3.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            ...
                            <div class="tp-caption Newspaper-Title-Centered layer2 tp-resizeme rs-parallaxlevel-0" 
                                ...
                                data-splitin="none" 
                                data-splitout="none" 
                                data-responsive_offset="on">Support Your Local
                            </div>
                            ...
                            <div class="tp-caption Newspaper-Button layer4 rev-btn rs-parallaxlevel-0" 
                                ...
                                data-responsive="off"><a href="about.php">Bestellen</a> 
                            </div>
                        </li>
            	...
            	<div class="row">
                    ...
                    <div class="medium-6 small-12 columns">
                    	<div class="highlight-box">
                            ...
                            <div class="tx-div"></div>
                        	<p>Wir liefern sichere, kostengünstige, frische und qualitativ hochwertige Produkte, die das Wohlbefinden der Verbraucher und die Integrität unserer Kunden schützen.</p>
                             </div>
                    </div>
                </div>    
            </div>
            ...
            <div class="medium-15 small-12 columns">
                <ul class="accordion" data-accordion>
                    <li class="accordion-item is-active" data-accordion-item>
                        ...
                        Das Essen, das wir hier anbieten, ist alles authentisch, da es von unserem Koch hergestellt wird, der etwas ganz Besonderes ist und viel Erfahrung in dieser Angelegenheit hat. Wir importieren die Gewürze meistens direkt aus Indien, die meistens als Integrienten verwendet werden (natürlich wurde die Qualität getestet)
                         </div>
                    </li>
                    ...
                    <li class="accordion-item" data-accordion-item>
                        ...
                        <div class="accordion-content" data-tab-content>
                        Seit unseren Eröffnungstagen in Oldenburg können wir Tausende zufriedener Gäste gewinnen. Wir möchten uns auch bei unseren treuen Gästen bedanken, die uns in unseren Höhen und Tiefen geholfen haben.
                       </div>
                    </li>
                    ...
                    <li class="accordion-item" data-accordion-item>
                        ...
                        <div class="accordion-content" data-tab-content>
                        Unser Plan zur Qualitätssicherung und Lebensmittelsicherheit ist eine sich ständig weiterentwickelnde vorbeugungsbasierte Kombination aus Produktstandards, Fachpersonal, strengen Bewertungsprogrammen und nachvollziehbarer, organisierter Kommunikation in der gesamten Lieferkette.   
                        </div>
                    </li>
                     <li class="accordion-item" data-accordion-item>
                        <a href="#" class="accordion-title">Nachhaltigkeit</a>
                        <div class="accordion-content" data-tab-content>
                        Nachhaltigkeit ist ein gutes Geschäft. Wir konzentrieren uns auf die schnelle Lieferung und die Wiederverwendung von Ressourcen für ein effizientes Transportsystem. Nachhaltigkeit spart Marketing- und Betriebskosten und verbessert gleichzeitig die Chancen für zukünftige Generationen.
                        </div>
                    </li>
        ...
        <div class="call-to-action">
           <div class="row">
                <div class="medium-10 small-12 columns">
                    <h2><i class="fa fa-phone" aria-hidden="true"></i> 	Wenn Sie Fragen haben, rufen Sie uns an <span>0441/96013838</span></h2>
                </div>
